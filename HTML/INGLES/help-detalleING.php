...
<html lang="en">
  ...
  <body>
    ...
    <div class="detalle-wrapper">
      <a href="helpING.php" class="detalle-volver"
        >&larr; Back to the Help Center</a
      >
    ...
    <script>
      ...
      // Kept in sync with localStorage so updated amounts are reflected
      ...
      if (persona) {
        contenedor.innerHTML = `
                ...
                <div class="detalle-info">
                    ...
                    <p><strong>Age:</strong> ${persona.edad} years</p>
                    <p><strong>Cancer type:</strong> ${persona.tipoCancer}</p>
                    <p><strong>Location:</strong> ${persona.ubicacion}</p>
                    <p><strong>Goal:</strong> ${persona.meta}</p>
                    <p><strong>Phone:</strong> ${persona.telefono}</p>
                    <div class="progress-container">
                        <span class="progress-text">Funds raised: $${persona.recaudado} / $${persona.objetivo}</span>
                        <div class="progress-bar-bg">
                            <div class="progress-bar-fill" style="width: ${persona.porcentaje}%;"></div>
                        </div>
                    </div>
                    <a href="../ESPANOL/donar.php?id=${persona.id}" class="btn-donar">
                        Donate Now
                    </a>
                </div>
            `;
      } else {
        contenedor.innerHTML = `<p>This person's information was not found.</p>`;
      }
    </script>
